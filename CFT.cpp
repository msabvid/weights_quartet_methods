...
/*compilar: g++ -std=c++0x CFT.cpp functions.o graphic.o -o CFT -O1 -larmadillo
  executar: ./CFT 1
  */
        ...
        for (int i2=i1+1; i2<n_taxa-2; ++i2) {
            for (int i3=i2+1; i3<n_taxa-1; ++i3) {
                for (int i4=i3+1; i4<n_taxa; ++i4) {
                    ...
                    outfile << coord1/sum << endl;
                    outfile << coord2/sum << endl;
                    outfile << coord3/sum << endl;
                    outfile.close();
                }
            }
        }
